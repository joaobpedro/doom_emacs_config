...
(setq-default default-directory "mnt")
...
(map! :leader "H f" 'harpoon-toggle-file)
...
;; Customize which words are highlighted by hl-todo
(after! hl-todo
  (setq hl-todo-keywords
        '(("TODO" . "#FF0000")   ; Red color for TODO
          ("FIXME" . "#FF4500")  ; OrangeRed color for FIXME
          ("NOTE" . "#0000FF")   ; Blue color for NOTE
